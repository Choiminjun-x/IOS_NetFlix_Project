...
struct MainNowPlayingListCellModel {
    var imageURL: String
}

class MainNowPlayingListCell: UICollectionViewCell {
    ...
    func displayCellModel(_ model: MainNowPlayingListCellModel) {
