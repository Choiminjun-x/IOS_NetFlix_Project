...
struct MainTopRatedListCellModel {
    var imageURL: String
}

class MainTopRatedListCell: UICollectionViewCell {
    ...
    func displayCellModel(_ model: MainTopRatedListCellModel) {
